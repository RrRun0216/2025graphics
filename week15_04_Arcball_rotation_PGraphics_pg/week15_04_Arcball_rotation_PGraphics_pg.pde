...
PGraphics pg, pg2, pg3, pg4;//在外面宣告,不同人都能使用
Arcball arcball;
void setup(){
...
void draw() {
  background(255, 0, 0); //紅背景
  pg.beginDraw();
  pg.background(0, 255, 0); //綠色背景
  arcball.run();
